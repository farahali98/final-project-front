      ...
      <Container style={{ marginTop: '100px' }}>
        ...
        <Table striped bordered hover>
          ...
          <tbody>
            ...
            {food.map((food) => { return <FoodItem key={food.id} food={food} handleShow={handleShow} handleDelete={handleDelete} index={food.id} />
            }
            )
            }
          </tbody>
...
const FoodItem = (props) => {
  const {food, handleShow, handleDelete, index } = props;
  const handleDeleteFunc = useCallback(() => handleDelete(index),[handleDelete]);
  const handleShowFunc = useCallback(() => handleShow(index),[handleShow]);
  ...
  return (
    <tr>
      ...
      <td>
        {/* <Button style={{ backgroundColor: '#eed202', borderColor: '#eed202', paddingBottom: '10px' }} onClick={handleShowFunc}>Update</Button> */}
        <br />
        <Button style={{ backgroundColor: 'red', borderColor: 'red' }} onClick={handleDeleteFunc}>Delete</Button></td>
    </tr>
  )
}
